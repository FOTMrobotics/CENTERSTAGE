...
@Autonomous
public class RedAutoNOBackdrop extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        int waitTime = 500;
        OpenCvWebcam webcam;
        TeamElementDetectionRed2 pipeline;
        ...
        pipeline = new TeamElementDetectionRed2();
...
class TeamElementDetectionRed2 extends OpenCvPipeline {
    Mat YCbCr = new Mat();
    Mat leftCrop;
    Mat rightCrop;
    double leftAvgFinal;
